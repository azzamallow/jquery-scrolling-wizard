...
describe('ScrollingWizard', function() {
  var options;
  options = {
    message: 'Hello World'
  };
  ...
  describe('plugin behavior', function() {
    it('should be available on the jQuery object', function() {
      return expect($.fn.scrollingWizard).toBeDefined();
    });
    it('should be chainable', function() {
      return expect(this.$element.scrollingWizard()).toBe(this.$element);
    });
    it('should offers default values', function() {
      var plugin;
      plugin = new $.scrollingWizard(this.$element);
